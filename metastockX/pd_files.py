# pd_files.py
# Creates data frames instead of text files
# Test file
"""
...
class DataFileInfo(object):
    ...
    def _load_columns(self):
        ...
        file_handle.close()
#        print len(lines), self.num_fields
#        print lines
#        exit()
    ...
    def candles_to_dataframe (self):
        """
        Load metastock DAT file and write the content
        to a dataframe, return the dataframe
        """
        file_handle = None
        outfile = None
